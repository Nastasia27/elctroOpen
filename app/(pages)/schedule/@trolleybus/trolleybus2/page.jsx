...
export default async function Page() {
    ...
    const routeData = data.data.find(item => item.attributes.routeNumber === '№2');
    ...
    const number = '№2'
    const title = 'Залізничний вокзал «Миколаїв -Пасажирський» - м/н Намив';
    ...
    const scheduleTrolleyBus2 = [
        {
            direction: 'Відправлення з кінцевої Залізничний вокзал «Миколаїв - Пасажирський»:',
            time: convertData(direction1)
        },
        {
            direction: 'Відправлення з кінцевої Ліски',
