...
export default async function Page() {
    ...
    const routeData = data.data.find(item => item.attributes.routeNumber === '№1');
    ...
    const number = routeData.attributes.routeNumber;
    const title = routeData.attributes.routeName;
    ...
    const scheduleTrolleyBus2 = [
        {
            direction: 'Відправлення з кінцевої Широка Балка',
            time: convertData(direction1)
        },
        {
            direction: 'Відправлення з кінцевої Яхт-клуб',
