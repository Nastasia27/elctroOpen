...
export default async function Page() {
    ...
    const routeData = data.data.find(item => item.attributes.routeNumber === '№7');
    ...
    const number = '№7'
    const title = 'Широка Балка - Центральний ринок';
    ...
    const scheduleTrolleyBus2 = [
        ...
        {
            direction: 'Відправлення з кінцевої Центральний ринок',
